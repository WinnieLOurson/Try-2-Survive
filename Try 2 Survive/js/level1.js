var Level1 = {
	...
	create: function () {		
		game.add.tileSprite(0, 0, width, height, 'background 1');

		//  Rotated button
		button1 = game.add.button(170, 100, 'button 1.1', actionOnClick1, this, 2, 1, 0);
		button1.angle = 24;
		button1.anchor.setTo(0.5, 0.5);

		//  Rotated button
		button2 = game.add.button(570, 100, 'button 1.2', actionOnClick2, this, 2, 1, 0);
		button2.angle = 24;
		button2.anchor.setTo(0.5, 0.5);

		//  Rotated button
		button3 = game.add.button(170, 500, 'button 1.3' , actionOnClick3, this, 2, 1, 0);
		button3.angle = 24;
		button3.anchor.setTo(0.5, 0.5);

		//  Rotated button
		button4 = game.add.button(570, 500, 'button 1.4' , actionOnClick4, this, 2, 1, 0);
		button4.angle = 24;
